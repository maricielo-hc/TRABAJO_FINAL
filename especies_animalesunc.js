const especies = [
  ...
  { nombre_cientifico: "Ajaia ajaja" },
  { nombre_cientifico: "Alouatta palliata" },
  { nombre_cientifico: "Alouatta seniculus" },
  { nombre_cientifico: "Altigius alios" },
  { nombre_cientifico: "Amazona festiva" },
  { nombre_cientifico: "Amorphochilus schnablii" },
  { nombre_cientifico: "Anairetes alpinus" },
  { nombre_cientifico: "Andigena hypoglauca" },
  { nombre_cientifico: "Aotus miconax" },
  { nombre_cientifico: "Ara chloroptera" },
  { nombre_cientifico: "Ara coulonii" },
  { nombre_cientifico: "Ara macao" },
  { nombre_cientifico: "Ara militaris" },
  { nombre_cientifico: "Aratinga erythrogenys" },
  { nombre_cientifico: "Arctocephalus australis" },
  ...
  { nombre_cientifico: "Batrachemys heliostemma" },
  ...
  { nombre_cientifico: "Boa constrictor ortonii" },
  { nombre_cientifico: "Bothrops andianus" },
  { nombre_cientifico: "Bothrops barnetti" },
  { nombre_cientifico: "Bothrops pictus" },
  { nombre_cientifico: "Bothrops roedingeri" },
  { nombre_cientifico: "Brotogeris pyrrhopterus" },
  { nombre_cientifico: "Bufo corinetes" },
  { nombre_cientifico: "Bufo spinulosus" },
  { nombre_cientifico: "Buthraupis aureodorsalis" },
  { nombre_cientifico: "Buthraupis wetmorei" },
  { nombre_cientifico: "Cacajao calvus" },
  { nombre_cientifico: "Cacicus koepckeae" },
  { nombre_cientifico: "Callicebus oenanthe" },
  { nombre_cientifico: "Callicebus torquatus" },
  { nombre_cientifico: "Callimico goeldii" },
  { nombre_cientifico: "Callopistes flavipunctatus" },
  { nombre_cientifico: "Campephilus guayaquilensis" },
  { nombre_cientifico: "Campylopterus villavicensio" },
  { nombre_cientifico: "Campylorhamphus pucherani" },
  ...
  { nombre_cientifico: "Centrolene euhytrix" },
  { nombre_cientifico: "Centrolene hesperium" },
  { nombre_cientifico: "Ceratophrys stolzmanni" },
  { nombre_cientifico: "Chaetophractus nationi" },
  { nombre_cientifico: "Chelonia mydas agassizzii" },
  { nombre_cientifico: "Chibchanomys trichotis" },
  ...
  { nombre_cientifico: "Conirostrum tamarugense" },
  { nombre_cientifico: "Conothraupis speculifera" },
  ...
  { nombre_cientifico: "Cryptotis peruviensis" },
  { nombre_cientifico: "Crypturellus casiquiare" },
  { nombre_cientifico: "Crypturellus duidae" },
  { nombre_cientifico: "Crypturellus transfasciatus" },
  { nombre_cientifico: "Ctenoblepharis adspersa" },
  { nombre_cientifico: "Cypseloides rothschildi" },
  { nombre_cientifico: "Dasypus pilosus" },
  { nombre_cientifico: "Dendrobates fantasticus" },
  { nombre_cientifico: "Dendrobates mysteriosus" },
  { nombre_cientifico: "Dendrobates reticulatus" },
  { nombre_cientifico: "Dermochelys coriacea" },
  { nombre_cientifico: "Deroptyus accipitrinus" },
  { nombre_cientifico: "Dicrodon heterolepis" },
  { nombre_cientifico: "Dicrodon holmbergi" },
  { nombre_cientifico: "Dinomys branickii" },
  ...
  { nombre_cientifico: "Epipedobates parvulus" },
  { nombre_cientifico: "Epipedobates petersi" },
  { nombre_cientifico: "Epipedobates planipaleae" },
  { nombre_cientifico: "Epipedobates ruvibentris" },
  { nombre_cientifico: "Epipedobates simulans" },
  { nombre_cientifico: "Epipedobates smaragdinus" },
  { nombre_cientifico: "Epipedobates tricolor" },
  { nombre_cientifico: "Epipedobates zaparo" },
  ...
  { nombre_cientifico: "Fulica gigantea" },
  { nombre_cientifico: "Fulica rufifrons" },
  ...
  { nombre_cientifico: "Grallaria blackei" },
  { nombre_cientifico: "Grallaria eludens" },
  ...
  { nombre_cientifico: "Heliodoxa gularis" },
  { nombre_cientifico: "Hemispingus rufosuperciliaris" },
  { nombre_cientifico: "Hemitriccus cinnamomeipectus" },
  { nombre_cientifico: "Hemitriccus minimus" },
  ...
  { nombre_cientifico: "Incaspiza ortizi" },
  ...
  { nombre_cientifico: "Lathrotriccus griseipectus" },
  ...
  { nombre_cientifico: "Melanopareia maranonica" },
  { nombre_cientifico: "Melanosuchus niger" },
  { nombre_cientifico: "Metallura odomae" },
  { nombre_cientifico: "Microlophus tigris" },
  { nombre_cientifico: "Mitu salvini" },
  { nombre_cientifico: "Mitu tuberosa" },
  { nombre_cientifico: "Monodelphis osgoodi" },
  ...
  { nombre_cientifico: "Nannopsittaca dachillae" },
  { nombre_cientifico: "Neochen jubata" },
  { nombre_cientifico: "Neopelma chrysocephalum" },
  { nombre_cientifico: "Netta erythropthalma" },
  { nombre_cientifico: "Neusticomys peruviensis" },
  { nombre_cientifico: "Notharchus ordii" },
  { nombre_cientifico: "Nothoprocta kalinowskii" },
  { nombre_cientifico: "Nothoprocta taczanowskii" },
  { nombre_cientifico: "Nyctibius leucopterus" },
  { nombre_cientifico: "Oceanodroma markhami" },
  { nombre_cientifico: "Octhoeca piurae" },
  ...
  { nombre_cientifico: "Otaria byronia" },
  { nombre_cientifico: "Otus marshalli" },
  { nombre_cientifico: "Oxymycterus hiska" },
  { nombre_cientifico: "Pachyramphus spodiurus" },
  { nombre_cientifico: "Paleosuchus palpebrosus" },
  { nombre_cientifico: "Paleosuchus trigonatus" },
  ...
  { nombre_cientifico: "Phaethornis koepckeae" },
  { nombre_cientifico: "Phalacrocorax bouganvilli" },
  { nombre_cientifico: "Phalacrocorax gaimardi" },
  { nombre_cientifico: "Phlegornis mitchellii" },
  { nombre_cientifico: "Phlogophilus harterti" },
  { nombre_cientifico: "Phlogophilus hemileucurus" },
  ...
  { nombre_cientifico: "Pterocnemia pennata" },
  { nombre_cientifico: "Pterodroma p. phaeopygia" },
  { nombre_cientifico: "Pteroglossus beauharnaesii" },
  ...
  { nombre_cientifico: "Saguinus labiatus" },
  { nombre_cientifico: "Saltator cinctus" },
  { nombre_cientifico: "Sciurus pyrrhinus" },
  { nombre_cientifico: "Sciurus sanborni" },
  ...
  { nombre_cientifico: "Synalaxis cherriei" },
  ...
  { nombre_cientifico: "Tachycineta stolzmanii" },
  { nombre_cientifico: "Tangara meyerdeschauenseei" },
  { nombre_cientifico: "Tangara phillipsi" },
  ...
  { nombre_cientifico: "Telmatobius breviceps" },
  ...
  { nombre_cientifico: "Thomasomys apeco" },
  { nombre_cientifico: "Thomasomys gracilis" },
  { nombre_cientifico: "Thomasomys incanus" },
  { nombre_cientifico: "Thomasomys kalinowskii" },
  { nombre_cientifico: "Thomasomys macrotis" },
  { nombre_cientifico: "Thomasomys onkiro" },
  { nombre_cientifico: "Thomasomys pretor" },
  { nombre_cientifico: "Thomasomys pyrrhonotus" },
  { nombre_cientifico: "Thomasomys rosalinda" },
  { nombre_cientifico: "Thomasomys taczanowskii" },
  { nombre_cientifico: "Thripophaga berlepschi" },
  { nombre_cientifico: "Tinamotis pentlandii" },
  ...
  { nombre_cientifico: "Xipholena punicea" },
  { nombre_cientifico: "Zaratornis stresemanni" },
  { nombre_cientifico: "Zimmerius villarejoi" },
  ...
  { nombre_cientifico: "Adelphobates quinquevittatus" },
  { nombre_cientifico: "Aegolius harrisii" },
  { nombre_cientifico: "Aglaeactis castelnaudii" },
  { nombre_cientifico: "Aglaeactis cupripennis" },
  { nombre_cientifico: "Aglaiocercus kingi" },
  { nombre_cientifico: "Agrias amydon boliviensis" },
  { nombre_cientifico: "Allobates femoralis" },
  { nombre_cientifico: "Allobates myersi" },
  { nombre_cientifico: "Allobates zaparo" },
  { nombre_cientifico: "Alopias pelagicus" },
  { nombre_cientifico: "Alopias superciliosus" },
  { nombre_cientifico: "Alopias vulpinus" },
  { nombre_cientifico: "Alouatta sara" },
  { nombre_cientifico: "Amazilia amazilia" },
  { nombre_cientifico: "Amazilia chionogaster" },
  { nombre_cientifico: "Amazilia fimbriata" },
  { nombre_cientifico: "Amazilia franciae" },
  { nombre_cientifico: "Amazilia lactea" },
  { nombre_cientifico: "Amazilia versicolor" },
  { nombre_cientifico: "Amazilia viridicauda" },
  { nombre_cientifico: "Amazona amazonica" },
  { nombre_cientifico: "Amazona farinosa" },
  { nombre_cientifico: "Amazona mercenaria" },
  { nombre_cientifico: "Amazona ochrocephala" },
  { nombre_cientifico: "Ameerega altamazonica" },
  { nombre_cientifico: "Ameerega bassleri" },
  { nombre_cientifico: "Ameerega cainarachi" },
  { nombre_cientifico: "Ameerega hahneli" },
  { nombre_cientifico: "Ameerega ignipedis" },
  { nombre_cientifico: "Ameerega labialis" },
  { nombre_cientifico: "Ameerega macero" },
  { nombre_cientifico: "Ameerega parvula" },
  { nombre_cientifico: "Ameerega pepperi" },
  { nombre_cientifico: "Ameerega peruviridis" },
  { nombre_cientifico: "Ameerega petersi" },
  { nombre_cientifico: "Ameerega picta" },
  ...
  { nombre_cientifico: "Ameerega silverstonei" },
  { nombre_cientifico: "Ameerega simulans" },
  { nombre_cientifico: "Ameerega smaragdina" },
  { nombre_cientifico: "Ameerega trivittata" },
  { nombre_cientifico: "Ameerega yoshina" },
  { nombre_cientifico: "Anthracothorax nigricollis" },
  { nombre_cientifico: "Anthracothorax prevostii" },
  { nombre_cientifico: "Aotus azarae" },
  { nombre_cientifico: "Aotus nancymaae" },
  { nombre_cientifico: "Aotus nigriceps" },
  { nombre_cientifico: "Aotus vociferans" },
  { nombre_cientifico: "Ara ararauna" },
  { nombre_cientifico: "Ara chloropterus" },
  { nombre_cientifico: "Arapaima gigas" },
  { nombre_cientifico: "Ara severus" },
  { nombre_cientifico: "Aratinga aurea" },
  { nombre_cientifico: "Aratinga leucophthalma" },
  { nombre_cientifico: "Aratinga mitrata" },
  { nombre_cientifico: "Aratinga wagleri" },
  { nombre_cientifico: "Aratinga weddellii" },
  { nombre_cientifico: "Arctocephalus philippii" },
  { nombre_cientifico: "Asio flammeus" },
  { nombre_cientifico: "Asio stygius" },
  { nombre_cientifico: "Astrangia haimei" },
  ...
  { nombre_cientifico: "Boissonneaua matthewsii" },
  { nombre_cientifico: "Bolborhynchus lineola" },
  { nombre_cientifico: "Bolborhynchus orbygnesius" },
  { nombre_cientifico: "Bradypus variegatus" },
  { nombre_cientifico: "Brotogeris cyanoptera" },
  { nombre_cientifico: "Brotogeris pyrrhoptera" },
  { nombre_cientifico: "Brotogeris sanctithomae" },
  { nombre_cientifico: "Brotogeris versicolurus" },
  ...
  { nombre_cientifico: "Buteogallus subtilis" },
  { nombre_cientifico: "Buteogallus urubitinga" },
  { nombre_cientifico: "Buteo leucorrhous" },
  { nombre_cientifico: "Buteo nitidus" },
  { nombre_cientifico: "Buteo platypterus" },
  { nombre_cientifico: "Buteo poecilochrous" },
  { nombre_cientifico: "Buteo polyosoma" },
  { nombre_cientifico: "Buteo swainsoni" },
  { nombre_cientifico: "Caiman crocodilus" },
  { nombre_cientifico: "Calliphlox amethystina" },
  { nombre_cientifico: "Callithrix pygmaea" },
  { nombre_cientifico: "Campylopterus largipennis" },
  { nombre_cientifico: "Campylopterus villaviscensio" },
  ...
  { nombre_cientifico: "Carcharhinus cerdale" },
  ...
  { nombre_cientifico: "Cebus albifrons" },
  { nombre_cientifico: "Cebus apella" },
  { nombre_cientifico: "Centrolene buckleyi" },
  { nombre_cientifico: "Centrolene charapita" },
  { nombre_cientifico: "Centrolene condor" },
  { nombre_cientifico: "Centrolene hesperia" },
  { nombre_cientifico: "Centrolene lemniscata" },
  { nombre_cientifico: "Centrolene muelleri" },
  { nombre_cientifico: "Centrolene sabini" },
  { nombre_cientifico: "Cephalopterus ornatus" },
  { nombre_cientifico: "Cerdocyon thous" },
  { nombre_cientifico: "Cetorhinus maximus" },
  { nombre_cientifico: "Chaetocercus bombus" },
  { nombre_cientifico: "Chaetocercus mulsanti" },
  { nombre_cientifico: "Chalcostigma herrani" },
  { nombre_cientifico: "Chalcostigma olivaceum" },
  { nombre_cientifico: "Chalcostigma ruficeps" },
  { nombre_cientifico: "Chalcostigma stanleyi" },
  { nombre_cientifico: "Chalybura urochrysia" },
  { nombre_cientifico: "Chelonia mydas" },
  { nombre_cientifico: "Chelonoidis carbonarius" },
  { nombre_cientifico: "Chelonoidis denticulatus" },
  { nombre_cientifico: "Chelus fimbriatus" },
  { nombre_cientifico: "Cheracebus lucifer" },
  { nombre_cientifico: "Chimerella corleone" },
  { nombre_cientifico: "Chimerella mariaelenae" },
  { nombre_cientifico: "Chinchilla chinchilla" },
  { nombre_cientifico: "Chlorostilbon mellisugus" },
  { nombre_cientifico: "Chlorostilbon notatus" },
  { nombre_cientifico: "Chlorostilbon poortmani" },
  { nombre_cientifico: "Chondrohierax uncinatus" },
  { nombre_cientifico: "Chrysocyon brachyurus" },
  { nombre_cientifico: "Chrysuronia oenone" },
  { nombre_cientifico: "Ciccaba huhula" },
  { nombre_cientifico: "Ciccaba nigrolineata" },
  { nombre_cientifico: "Ciccaba virgata" },
  { nombre_cientifico: "Circus cinereus" },
  { nombre_cientifico: "Clelia clelia" },
  { nombre_cientifico: "Cochranella erminea" },
  { nombre_cientifico: "Cochranella euhystrix" },
  { nombre_cientifico: "Cochranella guayasamini" },
  { nombre_cientifico: "Cochranella nola" },
  { nombre_cientifico: "Cochranella resplendens" },
  { nombre_cientifico: "Coeligena coeligena" },
  { nombre_cientifico: "Coeligena iris" },
  { nombre_cientifico: "Coeligena lutetiae" },
  { nombre_cientifico: "Coeligena torquata" },
  { nombre_cientifico: "Coeligena violifer" },
  { nombre_cientifico: "Colibri coruscans" },
  { nombre_cientifico: "Colibri delphinae" },
  { nombre_cientifico: "Colibri thalassinus" },
  { nombre_cientifico: "Corallus batesii" },
  { nombre_cientifico: "Corallus hortulanus" },
  { nombre_cientifico: "Crocodilurus amazonicus" },
  { nombre_cientifico: "Crotalus durissus" },
  { nombre_cientifico: "Cuniculus paca" },
  { nombre_cientifico: "Damophila julie" },
  { nombre_cientifico: "Daptrius ater" },
  { nombre_cientifico: "Dasyprocta punctata" },
  { nombre_cientifico: "Delphinus capensis" },
  { nombre_cientifico: "Delphinus delphis" },
  { nombre_cientifico: "Deltocyathus parvulus" },
  { nombre_cientifico: "Dendrocygna autumnalis" },
  { nombre_cientifico: "Dendrocygna bicolor" },
  { nombre_cientifico: "Diopsittaca nobilis" },
  { nombre_cientifico: "Discosura langsdorffi" },
  { nombre_cientifico: "Discosura popelairii" },
  { nombre_cientifico: "Doryfera johannae" },
  { nombre_cientifico: "Doryfera ludovicae" },
  { nombre_cientifico: "Dracaena guianensis" },
  { nombre_cientifico: "Eira barbara" },
  { nombre_cientifico: "Elanoides forficatus" },
  { nombre_cientifico: "Ensifera ensifera" },
  { nombre_cientifico: "Epicrates cenchria" },
  { nombre_cientifico: "Epipedobates anthonyi" },
  { nombre_cientifico: "Eriocnemis alinae" },
  { nombre_cientifico: "Eriocnemis luciani" },
  { nombre_cientifico: "Eriocnemis vestita" },
  { nombre_cientifico: "Espadarana audax" },
  { nombre_cientifico: "Eubalaena australis" },
  { nombre_cientifico: "Eunectes murinus" },
  { nombre_cientifico: "Eupetomena macroura" },
  { nombre_cientifico: "Eutoxeres aquila" },
  { nombre_cientifico: "Eutoxeres condamini" },
  { nombre_cientifico: "Excidobates captivus" },
  ...
  { nombre_cientifico: "Feresa attenuata" },
  { nombre_cientifico: "Florisuga mellivora" },
  { nombre_cientifico: "Forpus coelestis" },
  { nombre_cientifico: "Forpus modestus" },
  { nombre_cientifico: "Forpus xanthopterygius" },
  { nombre_cientifico: "Fungiacyathus marenzelleri" },
  { nombre_cientifico: "Fungiacyathus pseudostephanus" },
  { nombre_cientifico: "Gampsonyx swainsonii" },
  { nombre_cientifico: "Geranoaetus albicaudatus" },
  { nombre_cientifico: "Geranoaetus melanoleucus" },
  { nombre_cientifico: "Geranospiza caerulescens" },
  { nombre_cientifico: "Glaucidium bolivianum" },
  { nombre_cientifico: "Glaucidium brasilianum" },
  { nombre_cientifico: "Glaucidium hardyi" },
  { nombre_cientifico: "Glaucidium jardinii" },
  { nombre_cientifico: "Glaucidium parkeri" },
  { nombre_cientifico: "Glaucidium peruanum" },
  { nombre_cientifico: "Glaucis hirsutus" },
  { nombre_cientifico: "Globicephala macrorhynchus" },
  { nombre_cientifico: "Globicephala melas" },
  { nombre_cientifico: "Grampus griseus" },
  { nombre_cientifico: "Graydidascalus brachyurus" },
  { nombre_cientifico: "Hapalopsittaca melanotis" },
  { nombre_cientifico: "Haplophaedia assimilis" },
  { nombre_cientifico: "Haplophaedia aureliae" },
  { nombre_cientifico: "Harpagus bidentatus" },
  { nombre_cientifico: "Heliangelus amethysticollis" },
  { nombre_cientifico: "Heliangelus micraster" },
  { nombre_cientifico: "Heliangelus viola" },
  { nombre_cientifico: "Heliodoxa aurescens" },
  { nombre_cientifico: "Heliodoxa branickii" },
  { nombre_cientifico: "Heliodoxa leadbeateri" },
  { nombre_cientifico: "Heliodoxa rubinoides" },
  { nombre_cientifico: "Heliodoxa schreibersii" },
  { nombre_cientifico: "Heliomaster longirostris" },
  { nombre_cientifico: "Heliothryx auritus" },
  { nombre_cientifico: "Herpailurus yagouaroundi" },
  { nombre_cientifico: "Herpetotheres cachinnans" },
  { nombre_cientifico: "Hippocampus ingens" },
  { nombre_cientifico: "Hyalinobatrachium anachoretus" },
  { nombre_cientifico: "Hyalinobatrachium bergeri" },
  { nombre_cientifico: "Hyalinobatrachium carlesvilai" },
  { nombre_cientifico: "Hyalinobatrachium iaspidiense" },
  { nombre_cientifico: "Hyalinobatrachium mondolfii" },
  { nombre_cientifico: "Hyalinobatrachium munozorum" },
  { nombre_cientifico: "Hyalinobatrachium pellucidum" },
  { nombre_cientifico: "Hylocharis cyanus" },
  { nombre_cientifico: "Hylocharis sapphirina" },
  ...
  { nombre_cientifico: "Kinosternon scorpioides" },
  { nombre_cientifico: "Klais guimeti" },
  { nombre_cientifico: "Kogia breviceps" },
  { nombre_cientifico: "Kogia sima" },
  { nombre_cientifico: "Lafresnaya lafresnayi" },
  { nombre_cientifico: "Lagenodelphis hosei" },
  { nombre_cientifico: "Lagenorhynchus obscurus" },
  ...
  { nombre_cientifico: "Lesbia nuna" },
  { nombre_cientifico: "Lesbia victoriae" },
  { nombre_cientifico: "Leucippus baeri" },
  { nombre_cientifico: "Leucippus chlorocercus" },
  { nombre_cientifico: "Leucippus taczanowskii" },
  { nombre_cientifico: "Leucopternis kuhli" },
  { nombre_cientifico: "Leucopternis melanops" },
  { nombre_cientifico: "Leucopternis plumbeus" },
  { nombre_cientifico: "Leucopternis princeps" },
  { nombre_cientifico: "Leucopternis schistaceus" },
  { nombre_cientifico: "Lissodelphis peronii" },
  { nombre_cientifico: "Lontra longicaudis" },
  { nombre_cientifico: "Lophornis chalybeus" },
  { nombre_cientifico: "Lophornis delattrei" },
  { nombre_cientifico: "Lophornis stictolophus" },
  { nombre_cientifico: "Lophostrix cristata" },
  { nombre_cientifico: "Lycalopex culpaeus" },
  { nombre_cientifico: "Lycalopex griseus" },
  { nombre_cientifico: "Megaptera novaeangliae" },
  { nombre_cientifico: "Mesoplodon grayi" },
  { nombre_cientifico: "Mesoplodon peruvianus" },
  { nombre_cientifico: "Metallura aeneocauda" },
  { nombre_cientifico: "Metallura eupogon" },
  { nombre_cientifico: "Metallura phoebe" },
  { nombre_cientifico: "Metallura theresiae" },
  { nombre_cientifico: "Metallura tyrianthina" },
  { nombre_cientifico: "Micrastur buckleyi" },
  { nombre_cientifico: "Micrastur gilvicollis" },
  ...
  { nombre_cientifico: "Mirounga leonina" },
  ...
  { nombre_cientifico: "Myrmia micrura" },
  { nombre_cientifico: "Myrtis fanny" },
  { nombre_cientifico: "Nannopsittaca dachilleae" },
  { nombre_cientifico: "Nasolamia velox" },
  { nombre_cientifico: "Nasua narica" },
  { nombre_cientifico: "Negaprion brevirostris" },
  { nombre_cientifico: "Nymphargus chancas" },
  { nombre_cientifico: "Nymphargus mariae" },
  { nombre_cientifico: "Nymphargus mixomaculatus" },
  ...
  { nombre_cientifico: "Nymphargus truebae" },
  { nombre_cientifico: "Ocreatus underwoodii" },
  { nombre_cientifico: "Opisthoprora euryptera" },
  { nombre_cientifico: "Orcinus orca" },
  { nombre_cientifico: "Oreonympha nobilis" },
  { nombre_cientifico: "Oreotrochilus estella" },
  { nombre_cientifico: "Oreotrochilus melanogaster" },
  { nombre_cientifico: "Oroaetus isidori" },
  { nombre_cientifico: "Orthopsittaca manilata" },
  { nombre_cientifico: "Otus albogularis" },
  { nombre_cientifico: "Otus choliba" },
  { nombre_cientifico: "Otus ingens" },
  { nombre_cientifico: "Otus koepckeae" },
  { nombre_cientifico: "Otus petersoni" },
  { nombre_cientifico: "Otus roboratus" },
  { nombre_cientifico: "Otus watsonii" },
  { nombre_cientifico: "Pandion haliaetus" },
  { nombre_cientifico: "Parabuteo unicinctus" },
  { nombre_cientifico: "Paratrygon aiereba" },
  { nombre_cientifico: "Patagona gigas" },
  { nombre_cientifico: "Pecari tajacu" },
  { nombre_cientifico: "Penelope purpurascens" },
  { nombre_cientifico: "Peponocephala electra" },
  { nombre_cientifico: "Phaethornis atrimentalis" },
  { nombre_cientifico: "Phaethornis bourcieri" },
  { nombre_cientifico: "Phaethornis griseogularis" },
  { nombre_cientifico: "Phaethornis guy" },
  { nombre_cientifico: "Phaethornis hispidus" },
  { nombre_cientifico: "Phaethornis longirostris" },
  { nombre_cientifico: "Phaethornis malaris" },
  { nombre_cientifico: "Phaethornis philippii" },
  { nombre_cientifico: "Phaethornis ruber" },
  { nombre_cientifico: "Phaethornis stuarti" },
  { nombre_cientifico: "Phaethornis syrmatophorus" },
  { nombre_cientifico: "Phalcoboenus megalopterus" },
  { nombre_cientifico: "Phocoena spinipinnis" },
  { nombre_cientifico: "Physeter macrocephalus" },
  { nombre_cientifico: "Pionites leucogaster" },
  { nombre_cientifico: "Pionites melanocephalus" },
  { nombre_cientifico: "Pionopsitta barrabandi" },
  { nombre_cientifico: "Pionus chalcopterus" },
  { nombre_cientifico: "Pionus menstruus" },
  { nombre_cientifico: "Pionus sordidus" },
  { nombre_cientifico: "Pionus tumultuosus" },
  { nombre_cientifico: "Pithecia aequatorialis" },
  { nombre_cientifico: "Pithecia hirsuta" },
  { nombre_cientifico: "Pithecia inusta" },
  { nombre_cientifico: "Pithecia irrorata" },
  { nombre_cientifico: "Pithecia isabela" },
  { nombre_cientifico: "Pithecia monachus" },
  { nombre_cientifico: "Pithecia napensis" },
  { nombre_cientifico: "Pithecia rylandsi" },
  { nombre_cientifico: "Platyrrhinus lineatus" },
  { nombre_cientifico: "Plecturocebus brunneus" },
  { nombre_cientifico: "Plecturocebus caligatus" },
  { nombre_cientifico: "Plecturocebus cupreus" },
  { nombre_cientifico: "Plecturocebus discolor" },
  { nombre_cientifico: "Plecturocebus oenanthe" },
  { nombre_cientifico: "Plecturocebus urubambensis" },
  { nombre_cientifico: "Podocnemis sextuberculata" },
  { nombre_cientifico: "Polymyces montereyensis" },
  { nombre_cientifico: "Polyonymus caroli" },
  { nombre_cientifico: "Polytmus guainumbi" },
  { nombre_cientifico: "Polytmus theresiae" },
  { nombre_cientifico: "Potamotrygon motoro" },
  { nombre_cientifico: "Potos flavus" },
  { nombre_cientifico: "Prepona praeneste buckleyana" },
  ...
  { nombre_cientifico: "Pseudobatos prahli" },
  { nombre_cientifico: "Pseudorca crassidens" },
  { nombre_cientifico: "Pseudoscops clamator" },
  { nombre_cientifico: "Psilopsiagon aurifrons" },
  { nombre_cientifico: "Pteroglossus castanotis" },
  { nombre_cientifico: "Pterophanes cyanopterus" },
  { nombre_cientifico: "Pulsatrix melanota" },
  { nombre_cientifico: "Pulsatrix perspicillata" },
  { nombre_cientifico: "Pyrrhura albipectus" },
  { nombre_cientifico: "Pyrrhura melanura" },
  { nombre_cientifico: "Pyrrhura parvifrons" },
  { nombre_cientifico: "Pyrrhura picta" },
  { nombre_cientifico: "Pyrrhura rupicola" },
  { nombre_cientifico: "Ramphastos tucanus" },
  { nombre_cientifico: "Ramphastos vitellinus" },
  { nombre_cientifico: "Ramphomicron microrhynchum" },
  { nombre_cientifico: "Ranitomeya amazonica" },
  { nombre_cientifico: "Ranitomeya benedicta" },
  { nombre_cientifico: "Ranitomeya cyanovittata" },
  { nombre_cientifico: "Ranitomeya fantastica" },
  { nombre_cientifico: "Ranitomeya flavovittata" },
  { nombre_cientifico: "Ranitomeya imitator" },
  { nombre_cientifico: "Ranitomeya reticulata" },
  { nombre_cientifico: "Ranitomeya sirensis" },
  { nombre_cientifico: "Ranitomeya summersi" },
  { nombre_cientifico: "Ranitomeya toraro" },
  { nombre_cientifico: "Ranitomeya uakarii" },
  { nombre_cientifico: "Ranitomeya vanzolinii" },
  { nombre_cientifico: "Ranitomeya variabilis" },
  { nombre_cientifico: "Ranitomeya ventrimaculata" },
  { nombre_cientifico: "Ranitomeya yavaricola" },
  { nombre_cientifico: "Rhincodon typus" },
  { nombre_cientifico: "Rhizoprionodon longurio" },
  { nombre_cientifico: "Rhodopis vesper" },
  { nombre_cientifico: "Rostrhamus hamatus" },
  { nombre_cientifico: "Rostrhamus sociabilis" },
  { nombre_cientifico: "Rulyrana mcdiarmidi" },
  ...
  { nombre_cientifico: "Saguinus fuscicollis" },
  { nombre_cientifico: "Saguinus graellsi" },
  { nombre_cientifico: "Saguinus imperator" },
  { nombre_cientifico: "Saguinus melanoleucus" },
  { nombre_cientifico: "Saguinus mystax" },
  { nombre_cientifico: "Saguinus nigricollis" },
  { nombre_cientifico: "Saguinus tripartitus" },
  { nombre_cientifico: "Saimiri boliviensis" },
  { nombre_cientifico: "Saimiri sciureus" },
  { nombre_cientifico: "Sappho sparganura" },
  { nombre_cientifico: "Sarkidiornis melanotos" },
  { nombre_cientifico: "Schistes geoffroyi" },
  ...
  { nombre_cientifico: "Stenella attenuata" },
  { nombre_cientifico: "Stenella coeruleoalba" },
  { nombre_cientifico: "Stenella longirostris" },
  { nombre_cientifico: "Steno bredanensis" },
  { nombre_cientifico: "Strix albitarsis" },
  { nombre_cientifico: "Tamandua mexicana" },
  { nombre_cientifico: "Taphrospilus hypostictus" },
  { nombre_cientifico: "Tayassu pecari" },
  { nombre_cientifico: "Teratohyla amelie" },
  { nombre_cientifico: "Teratohyla midas" },
  { nombre_cientifico: "Thalurania fannyi" },
  { nombre_cientifico: "Thalurania furcata" },
  { nombre_cientifico: "Thaumastura cora" },
  { nombre_cientifico: "Threnetes niger" },
  { nombre_cientifico: "Topaza pyra" },
  { nombre_cientifico: "Touit huetii" },
  { nombre_cientifico: "Touit purpuratus" },
  { nombre_cientifico: "Touit stictopterus" },
  { nombre_cientifico: "Tropidophis battersbyi" },
  { nombre_cientifico: "Tropidophis paucisquamis" },
  { nombre_cientifico: "Tropidophis taczanowskyi" },
  { nombre_cientifico: "Tupinambis cuzcoensis" },
  { nombre_cientifico: "Tupinambis teguixin" },
  { nombre_cientifico: "Tursiops truncatus" },
  { nombre_cientifico: "Tyto alba" },
  { nombre_cientifico: "Urochroa bougueri" },
  { nombre_cientifico: "Urosticte benjamini" },
  { nombre_cientifico: "Vitreorana ritae" },
  { nombre_cientifico: "Ziphius cavirostris" }
];
